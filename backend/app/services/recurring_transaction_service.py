...
async def update_recurring_transaction(
    ...
    if "funding_domain_id" in update_data and update_data["funding_domain_id"] is not None:
        await get_assignable_funding_domain(
            session, update_data["funding_domain_id"], workspace_id,
        )
    ...
    for recurring in recurring_list:
        ...
        while True:
            ...
            if existing_real is not None:
                ...
                if existing_real.funding_domain_id is None:
                    existing_real.funding_domain_id = recurring.funding_domain_id
            else:
