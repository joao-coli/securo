...
import type { Category, FundingDomain, Payee, Rule, RuleAction, RuleCondition, RuleConditionNode, RuleExportPayload } from '@/types'
...
export default function RulesPage() {
  ...
  const fundingDomains = useMemo(() => fundingDomainsList ?? [], [fundingDomainsList])
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-emerald-600 font-medium mt-0.5">
                      {actionSummary(rule.actions, displayCategories, payees, fundingDomains, t)}
                    </p>
                  </div>
                  {canWrite && (
